    ...
    try {
      const { data: stream, error } = await supabase
        ...
        .insert([{
          ...
          thumbnail_url: formData.thumbnail_url || `https://img.youtube.com/vi/${formData.youtube_id}/maxresdefault.jpg`,
        }])
        .select()
        .single();
          ...
          <Card key={stream.id}>
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <Badge variant={stream.status === 'active' ? 'destructive' : 'secondary'}>
