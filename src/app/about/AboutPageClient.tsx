  ...
  return (
    <div className="space-y-32">
      ...
      <section className="relative rounded-3xl overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-rugby-teal to-rugby-teal/80 rounded-3xl opacity-90" />
        <div className="relative text-center space-y-8 p-8 md:p-12">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link 
                href="/training"
                className="bg-rugby-yellow text-white px-8 py-3 rounded-lg hover:bg-rugby-yellow/90 transition-colors font-medium"
              >
                View Schedule
              </Link>
            </div>
